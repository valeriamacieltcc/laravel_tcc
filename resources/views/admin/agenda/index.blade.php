...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@7.0.2/locales/pt-br.global.min.js"></script>
    ...
    <main class="agenda-container">
        ...
        <div class="legenda-agenda">
            ...
            <div>
                ...
                <span>Agendamento de cliente</span>
            </div>
